...
export function Layout({ children, currentView, onNavigate, user }: LayoutProps) {
  ...
  const studentNavItems: NavItem[] = [
    ...
    { id: 'backend_course', label: 'Python Backend', icon: <Server size={20} />, customColor: 'text-emerald-400', trackRequirement: 'backend' },
    ...
    { id: 'gallery', label: "Ko'rgazma", icon: <LayoutGrid size={20} />, customColor: 'text-brand-cyan' },
